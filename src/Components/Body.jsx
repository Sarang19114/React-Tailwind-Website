    ...
    return (
       <div className="-space-y-4 lg:flex ">
        ...
        <div className="lg:flex-1 lg:order-1">
            ...
            <p className="font-lato text-gray-400">With Hoster, get your website up and running in no less than 5 mintues with the most competitive pricing packages available online</p>
            <form action="" className="flex flex-col gap-4 md:flex-row">
                <input className="round-md px-4 py-3 placeholder:text-gray-400" type="email" placeholder="Enter email address" />
                <button className="round-md px-4 py-3 bg-blue-400 hover:bg-blue-600 text-white">Join Waitlist</button>
            </form>
            <div className="flex gap-2">
                <img src="./src/assets/Checkmark.svg" alt="check" />
                <p className="font-lato text-gray-400 my-2">No spam, ever. Unsubscribe anythime</p>
            </div>
        </div>
       </div> 
    )
